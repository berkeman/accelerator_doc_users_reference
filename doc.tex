...
\begin{center}
  ...
  \vfill
  {\Large NOTE: Parts of this document are out of date.\\  We are
  currently prioritising the online documentation available at\\[2ex]
  \texttt{https://exax.readthedocs.io}}
  \vfill
